  ...
  return (
    <div className="pt-[100px] p-4 space-y-6">
      <div className="text-center space-y-2 p-2">
        <h2 className="text-3xl font-bold text-[#afad55]">Your Order History</h2>
      ...
      <div>
        {orders.length === 0 ? (
          ...
          orders.map((order) => (
            <div key={order._id} className="bg-[#f1e2c2] p-6 shadow-lg space-y-4 mb-6">
              <h3 className="text-2xl font-semibold mb-4">Order #{order._id}</h3>
              ...
              <button
                onClick={() => navigate(`/order-summary`, { state: { orderItems: order.orderItems, totalPrice: order.totalPrice } })}
